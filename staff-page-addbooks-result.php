        ...
        <nav class="sdb_holder">
          <ul>
            ...
            <li class="active"><a href="#">Manage Books</a>
              <ul>
                <li class="active"><a href="staff-page-addbooks.php">Add books</a></li>
...
$title=$_POST['title'];
$year=$_POST['year'];
$author_firstname=$_POST['first_name'];
$author_lastname=$_POST['last_name'];
$publisher_name=$_POST['publisher_name'];
$languages_name=$_POST['language'];
...
$result = mysqli_query($con,"
  INSERT INTO
   books (books_id,title,year,authors_id,publishers_id,languages_id,genres_id) 
   VALUES('$books_id','$title','$year','$authors_id','$publishers_id','$languages_id','$genres_id')");

if($result === true){
  echo "<h2>Book record has been successfully inserted.</h2>";
}
else{
...
?>
<a href="staff-page-addbooks.php">Back to Add Page</a>
