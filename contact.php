  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
        ...
        <li class="active"><a href="#">Contact Us</a></li><?php
  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div class="clear">
          ...
          <figure>
          <header class="heading">Contact Information & Customer Service</header></figure>
          <p style = "color: black; font-size: 17px;">CONTACT INFORMATION</p>
          <br>
          <address>
        ...
        11 Yuk Choi Rd, Hung Hom
          ...
          <br>
          <p style = "color: black; font-size: 17px;"> OUR TEAM MEMBER</p>
          <br>
          <p style = "color: #404040;">Reynold</p>
          <p> <i class="fa fa-phone pright-10"></i> 852 123-1234 / contact@domain.com</a></p>
          <p style = "color: #404040;">Steven</p>
          <p> <i class="fa fa-phone pright-10"></i> 852 123-1234 / contact@domain.com</a></p>
          <p style = "color: #404040;">Lynn</p>
          <p> <i class="fa fa-phone pright-10"></i> 852 123-1234 / contact@domain.com</a></p>
          <p style = "color: #404040;">Alison</p>
          <p> <i class="fa fa-phone pright-10"></i> 852 123-1234 / contact@domain.com</a></p>
          <br>
          <p style = "color: black; font-size: 17px;">GENERAL INQUIRIES</p>
          <br>
          <p><span style = "color: #404040; font-weight: bold;">Call</span> 852-111-1111</p>
  ...
  <div class="rounded">
    <footer id="footer" class="clear"> 
      ...
      <div class="one_third">
        ...
        Postcode<br>
        <br>
        <i class="fa fa-phone pright-10"></i> 852 1234-1234<br>contact@domain.com</a>
        </address>
      </div>
      <div class="one_third">
