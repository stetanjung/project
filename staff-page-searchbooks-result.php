      ...
      ?></br>
        ...
        <table>
          <tr>
            ...
            <td>Genre</td>
            <?php
            if(isset($_SESSION['users_id']) && $_SESSION['users_id']!='000000'){
                echo "<td>Available?</td><td>Borrow</td>";
            }
        ...
        while($row=mysqli_fetch_array($search_book_query,MYSQLI_ASSOC)){
          ...
          echo "
            <tr>
              ...
              <td>$genres_name</td>
            ";
            if(($_SESSION['users_id'])!='000000'){echo "<td>$available</td>";

              if($row['available']==1 && !isset($_SESSION["users_id"])) echo "<td><a href='log-in.php'>login first</a></td>";
    else if($row['available']==1 && isset($_SESSION["users_id"])) echo "<form action='member-page-borrow.php' method='POST'><td><input type='checkbox' name='borrow[]' value='$row[books_id]'></td>";
        ...
        <?php echo "<input type='submit' value='Borrow!'>"; ?>
        <?php
        if(strcmp($_SESSION['users_id'],"000000")==0){
