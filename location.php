    ...
    <main class="container clear"> 
      <div class="clear">
        <h1>Location</h1>
          ...
          function myMap() {
          var mapOptions = {
              center: new google.maps.LatLng(22.280138, 114.189636),
              zoom: 100,
          ...
          <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxbAPSQyFasBNOpRdK7y5UmFvlNCmfyNY&callback=myMap"></script>
          <!--
