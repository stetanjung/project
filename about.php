  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div class="clear">
          ...
          <figure>
          <header class="heading">About Us</header></figure>
          <p style = "color: black; font-size: 17px;">The Hong Kong Children's Library</p>
          <br>
          <p style="text-indent: 1em; font-size: 15px;">
          As a Children's Library, we provide educational, recreational, and cultural resources for children aged 6 to 11. We aim to develop children’s reading, research, and creativity skills through different programs and activities. This website for Children’s Library provides students with 24/7 access to library resources from anywhere, anytime.
          </p>
          <br>
          <p style = "color: black; font-size: 17px;">Created By:</p>
          <br>
          <p style="text-indent: 1em; font-size: 15px;">Reynold</p>
          <p style="text-indent: 1em; font-size: 15px;">Steven</p>
          <p style="text-indent: 1em; font-size: 15px;">Lynn</p>
          <p style="text-indent: 1em; font-size: 15px;">Alison</p>
