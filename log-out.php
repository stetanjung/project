  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div class="clear">
          ...
          <figure>
          <header class="heading">You are logged out</header></figure>



                <div class="container" style="background-color: white">
                <div  class="forma" style="background-color: white">
                  <form id="contactform" action="log-in-process.php" method="POST"> 
                    ...
                    <input class="buttom" name="submit" id="submit" tabindex="5" value="Log In" type="submit" style="float: right">
                    </form> 
                   </div>      
                 </div>
